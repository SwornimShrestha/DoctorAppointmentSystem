          ...
          <div>
            <div className='lg:w-[570px]'>
              ...
              <p className="text__para">
               lorem cgvdcugcduc yhdiygdv hdsvu udhvd,
               sduygyugd jhdfusdg fdsuygsuyg sdfyguyd,
               dshgydgf furfr eygfeygf fyegfygf frygfi,
               fegfyrefr fyguyr uyry uhefgf wgrbigg gh.
              </p>
            ...
            lg:gap-[30px]'>
              <div>
                <h2 className="text-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px] from-neutral-700
                text-headingColor">
                  30+
                </h2>
